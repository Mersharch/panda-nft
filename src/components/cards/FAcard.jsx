...
const FAcard = ({fImg, fName, fPrice}) => {
  return (
    <div className='px-3 py-5 hover:bg-slate-600 flex flex-col items-center hover:border duration-500 hover:border-[#1e50ff] hover:rounded-2xl hover:px-2 justify-center'>
        <div>
